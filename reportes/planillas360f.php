...
while ($rowE = mysql_fetch_array($resEquipos)) {
	...
	$pdf->SetXY(87,7);
	$pdf->Cell(70,5,substr(strtoupper($rowE['descripciontorneo']),0,28),1,0,'L',false);
	...
	$pdf->Cell(120,5,strtoupper($rowE['nombre']),1,0,'L',false);
	//$pdf->Cell(53,5,'Fecha: '.$rowE['fechajuego'],0,0,'R',false);
	$pdf->SetXY(65,21);
	$pdf->Cell(22,5,utf8_decode('capitán'),0,0,'C',false);
	$pdf->Cell(120,5,strtoupper($rowE['nombrecapitan']),1,0,'L',false);
	$pdf->SetXY(65,28);
	$pdf->Cell(22,5,utf8_decode('teléfono'),0,0,'C',false);
	$pdf->Cell(120,5,strtoupper($rowE['telefonocapitan']),1,0,'L',false);
	
	$pdf->SetFont('Arial','',10);
	//$pdf->SetXY(163,20);
	//$pdf->Cell(35,5,'Segu� el torneo en',0,0,'L',false);
	//$pdf->SetXY(163,25);
	...
	//$pdf->SetXY(5,37);
	//$pdf->SetFont('Arial','',9);
	//$pdf->Cell(180,7,'* el capit�n debe ser responsable de hcequear las estadisticas computadas y firmar la planilla. No se aceptar�n reclamos posteriores.',0,0,'L',false);
	/***********************************    FIN ******************************************/
