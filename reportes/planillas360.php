...
while ($rowE = mysql_fetch_array($resEquipos)) {
	...
	$pdf->Cell(80,5,strtoupper($rowE['nombre']),1,0,'L',false);
	$pdf->Cell(53,5,'Fecha: '.$rowE['fechajuego'],0,0,'R',false);
	$pdf->SetXY(45,21);
	$pdf->Cell(22,5,utf8_decode('capitán'),0,0,'C',false);
	$pdf->Cell(80,5,strtoupper($rowE['nombrecapitan']),1,0,'L',false);
	$pdf->SetXY(45,28);
	$pdf->Cell(22,5,utf8_decode('teléfono'),0,0,'C',false);
	$pdf->Cell(80,5,strtoupper($rowE['telefonocapitan']),1,0,'L',false);
	
	$pdf->SetFont('Arial','',10);
	$pdf->SetXY(163,20);
	$pdf->Cell(35,5,utf8_decode('Seguí el torneo en'),0,0,'L',false);
	$pdf->SetXY(163,25);
	...
	$pdf->SetXY(5,37);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(180,7,utf8_decode('* el capitán debe ser responsable de hcequear las estadisticas computadas y firmar la planilla. No se aceptarán reclamos posteriores.'),0,0,'L',false);
	/***********************************    FIN ******************************************/
	...
	$pdf->SetFont('Arial','',12);
	$pdf->Cell(25,5,utf8_decode('#Depósito'),0,0,'L',false);
	...
	$pdf->Ln();
	$pdf->SetX(19);
	$pdf->MultiCell(65,4,utf8_decode('En las primeras tres fechas los equipos deberán abonar el depósito, el cual se reintegraró en las Copas o Promociones al finalizar el torneo. (En caso de faltar a algún partido el equipo perderá el depósito).'),0,'','');
	...
	$pdf->Ln();
	$pdf->SetX(19);
	$pdf->MultiCell(65,4,utf8_decode('El uso de canilleras será obligatorio a partir de la segunda fecha. IMPORTANTE: Si un jugador de un equipo no utiliza canilleras, o se las saca durante el partido, el equipo acumulará automáticamente una tarjeta amarilla a la Tabla Fair Play.'),0,'','');
	...
	$pdf->Ln();
	$pdf->SetX(19);
	$pdf->MultiCell(65,4,utf8_decode('¿Cuántos jugadores nuevos puedo anotar por partido?. Se podrán incluir hasta dos jugadores nuevos por partido, hasta llegar al límite de 18 inscriptos.'),0,'','');
	$pdf->SetFont('Arial','B',7);
	$pdf->SetX(19);
	$pdf->Cell(65,4,utf8_decode('La edad permitida es de 18 a 40 años.'),0,0,'L',false);
	...
	$pdf->Cell(77,10,utf8_decode('depósito acreditado'),1,0,'C',false);
	...
	$pdf->Cell(38.5,10,utf8_decode('inscripción'),1,0,'L',false);
	$pdf->Cell(38.5,10,'',1,0,'L',false);
	...
	$pdf->Cell(38.5,10,utf8_decode('Pagó'),1,0,'L',false);
	...
	$pdf->Cell(77,10,utf8_decode('Firma Capitán:'),1,0,'L',false);
	$pdf->Cell(38.5,10,'-',1,0,'C',false);
	/////////////////////  FIN PARA LOS PAGOS  //////////////////////////////////////////////////////
