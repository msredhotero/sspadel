	...
	function traerZonasPorTorneo($idtorneo) {
		$sql = "select tge.refgrupo,g.nombre, t.idtorneo 
				...
				inner 
				        ...
				        on t.reftipotorneo = tp.idtipotorneo and tp.activo = 1
...
left join
	...
	function SuspendidosNuevo($idtorneo,$zona,$reffecha) {
		...
		$reffecha = $this->UltimaFechaPorTorneoZona($idtorneo,$zona);
		
		if (mysql_num_rows($reffecha)>0) {
		
			$reffecha = mysql_result($reffecha,0,0);	
