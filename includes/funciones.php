...
class Servicios {
	...
	function traerTipoTorneo() {
		$sql = "SELECT idtipotorneo,descripciontorneo,idtipotorneo, (case when activo = '1' then 'Si' else 'No' end) as activo FROM tbtipotorneo order by descripciontorneo";
	...
	function traerTipoTorneoActivo() {
		$sql = "SELECT idtipotorneo,descripciontorneo,idtipotorneo FROM tbtipotorneo where activo = 1 order by descripciontorneo";
		$res 	=	$this->query($sql,0);
...
/* Fin */
	...
	function insertarTipoTorneo($descripciontorneo, $activo) {
		$sql = "insert into tbtipotorneo(idtipotorneo,descripciontorneo, activo)
		values ('','".utf8_decode($descripciontorneo)."',".$activo.")";
		$res = $this->query($sql,1);
		return $res;
	}
	
	
	function modificarTipoTorneo($id,$descripciontorneo,$activo) {
	...
	function traerTipoTorneoPorId($id) {
		$sql = "select idtipotorneo,descripciontorneo, activo from tbtipotorneo where idtipotorneo =".$id;
		$res = $this->query($sql,0);
		return $res;
	}
